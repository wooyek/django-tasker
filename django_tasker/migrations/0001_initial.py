# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-14 16:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Created'), (1, 'Queued'), (2, 'Busy'), (4, 'Success'), (5, 'Error'), (6, 'Corrupted')], default=django_tasker.models.TaskStatus(0))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_tasks_per_hour', models.PositiveSmallIntegerField(blank=True, null=True)),
